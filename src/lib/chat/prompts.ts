...
export function seatSystemPrompt(seat: Seat, roster: Seat[], task?: string | null): string {
  ...
  return [
    ...
    "- If nobody seated can do the work, bring in someone who can: list_ranks to see who is available, add_seat to",
    "  seat them. When the host asks us to add, bring in or invite someone, that is this tool — do it rather than",
    "  asking what they meant. Give them a one-line role; the human confirms before the seat appears.",
    "  Seat a rank for ongoing work, ask_seat for a single question.",
